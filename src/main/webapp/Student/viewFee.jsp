...
<h1 class="text-5xl font-extrabold">Register Courses</h1>
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
			<%
				...
				String sql ="SELECT  course_code, course_name, credits FROM public.course";
				ResultSet resultSet = statement.executeQuery(sql);
				String s = (String)session.getAttribute("st_id");
				int fee = 8000;
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
				<td scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white"><%=resultSet.getString("course_code") %></td>
				<td scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white"><%=resultSet.getString("course_name") %></td>
				<td scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white"><%=resultSet.getString("credits") %></td>
				<td scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white"><%= cFee %></td>
			</tr>
        </tbody>
        <%
			}
